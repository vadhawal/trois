...
register_setting(
    ...
    description=_("Notification emails for comments posted."),
    editable=False,
    default="msaurabh.nitw@gmail.com",
)


register_setting(
    name="COMMENTS_ACCOUNT_REQUIRED",
    description=_("Login required for comment."),
    editable=False,
    default=True,
)
...
register_setting(
    ...
    editable=True,
    default=_("A complete shopping platform for all your needs."),
)
